...
var BMFont = (_temp = _class2 = function (_Sprite) {
  ...
  function BMFont(attr) {
    (0, _classCallCheck3.default)(this, BMFont);

    if (typeof attr === 'string') {
      attr = { text: attr };
    }
    return (0, _possibleConstructorReturn3.default)(this, (BMFont.__proto__ || (0, _getPrototypeOf2.default)(BMFont)).call(this, attr));
  }
